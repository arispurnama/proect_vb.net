...
Public Class rptTransaksi
    ...
    Private Sub rptTransaksi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MyKoneksi.Open()
        Dim rpt As New CrystalReport3() 'Report yang telah dibuat.
